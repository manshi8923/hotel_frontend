  ...
  return (
    ...
    <div className='revenue'>
        ...
        <Card.Body>
          ...
          <Button variant="primary" onClick={()=>navigate('/dashboard/ma')} >Go to Dashboard</Button>
        </Card.Body>
      </Card>
      <Card style={{ width: '18rem' ,margin:'2rem'}}>
        ...
        <Card.Body>
          ...
          <Button variant="primary" onClick={()=>navigate('/dashboard/oth')} >Go to Dashboard</Button>
        </Card.Body>
      </Card>
      </div>
    </>
